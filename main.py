...
def ouvrir_ajout_bien_immobilier():
    ...
    adresse_type_voie_label.place(x=222, y=55)
    ...
    cp_adresse_entry.place(x=400, y=55)
    ...
    nom_ville_adresse_entry.place(x=400, y=55)
    ...
    nombre_pieces_entry.grid(row=6, column=1, padx=10, pady=10)
